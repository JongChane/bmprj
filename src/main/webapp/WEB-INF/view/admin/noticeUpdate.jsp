...
<body>
<div>
<h2 class="mt-5 mb-5">공지사항 수정</h2>
	<form:form modelAttribute="notice" action="noticeUpdate" method="post">
		...
		<div class="mt-5 text-center"><input type="submit" value="공지수정"></div>
		</form:form>
</div>
</body>
</html>