...
$(document).on('click', '#mail-Check-Btn', function() {
    ...
    $.ajax({
        type: 'get',
        url: '<c:url value="/user/pwMailCheck?email="/>' + fullEmail + '&user_id=' + userId,
        success: function (data) {
        	if (data === "idEmailIsEmpty") {
        		alert('아이디에 해당하는 이메일을 찾을 수 없습니다.')
        	} else {
    ...
    <font color="red">
  	...
  	<table class="w3-table">
  		<tr>
  			<th>아이디</th>
  			<td>
  				<input type="text" name="user_id" class="w3-input">
     			<font color="red">
    	...
    	<tr>
	    	<td colspan="2" class="w3-center">
      		<input type="submit" value="비밀번호찾기" class="w3-btn w3-blue">
      	</td>
    	</tr>
  	</table>
	</form:form>
